...
SEED=0;
DATASET=tacred;
python train_tacred.py --model_name bert-base-cased --input_format $INPUT_FORMAT --seed $SEED --dataset $DATASET --mode $MODE --train_name $TRAIN_NAME --gradient_accumulation_steps 1 --train_batch_size 64;
